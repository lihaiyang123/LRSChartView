...
//  LRSChartView
//
//  Created by lihaiyang on 2019/6/19.
...
-(void)addFirstChartView{
    LRSChartView *incomeChartLineView = [[LRSChartView alloc]initWithFrame:CGRectMake(20, 50, [UIScreen mainScreen].bounds.size.width - 40, 300)];
    //是否默认选中第一个
    ...
    //设置折线样式
    incomeChartLineView.chartViewStyle = LRSChartViewMoreClickLine;
    //设置图层效果
    incomeChartLineView.chartLayerStyle = LRSChartGradient;
    //设置折现效果
    incomeChartLineView.lineLayerStyle = LRSLineLayerNone;
